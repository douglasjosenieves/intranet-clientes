...
require_once '../asesor_funtion.php';
					...
					$i=0;
					$resul =  mysql_query("SELECT * FROM `nota_entrega` where anulado <> 1");
					 ...
					 <!-- Button Extra small -->
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="../mod_nota_entrega/index.php?tipo=editar&id=<?php echo $opciones['opciones'][$i]['id']; ?>" title="#"><i class="fa fa-eye"></i> Gestionar</a></li>
