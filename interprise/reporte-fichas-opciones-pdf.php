...
<head>
	...
	<title>Fichas de opciones PDF</title>
		...
		<div class="pageContent extended">
			<div class="container">
				<h1 class="pageTitle">
					...
					<a href="#" title="#" class="hidden-print">Fichas de opciones PDF</a>
				</h1>
...
<div class="colorea_blanco_print">(Ref.<?php echo $opciones['opciones'][0]['ref'] ?>)</div>
	...
	<!-- Statsbar -->
					...
					<div class="row">
						...
						<div id="cuadro_alquiler" class="col-xs-12 col-xs-12 i green">
							<a href="#" title="#" class="c">
								<h3 class="title">Alquiler</h3>
								<div class="num"><?php echo $opciones['opciones'][0]['alquiler'] ?> €</div>
							...
							<a href="#" title="#" class="c">
								<h3 class="title">Antigüedad</h3>
								<div class="num"><?php echo $opciones['opciones'][0]['antiguedad'] ?> Años</div>
