		...
		<div class="pageContent extended">
			<div class="container">
				...
				<div class="box box-without-bottom-padding">
					<h2 class="boxHeadline">Cotizaciones Table</h2>
	                ...
	                <?php 
					$i=0;
					$resul =  mysql_query("SELECT * FROM `cotizaciones` where anulado <> 1");
					...
					<tr>
					    ...
					    <td><?php echo $opciones['opciones'][$i]['reglon_total']; ?></td>
					    <td>
					 ...
					 <!-- Button Extra small -->
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="forms-cotizaciones-ver.php?id=<?php echo $opciones['opciones'][$i]['id']; ?>" title="#"><i class="fa fa-eye"></i> Ver</a></li>
							
						
								
								<li><a href="reporte-cotizaciones-excel.php?id=<?php echo $opciones['opciones'][$i]['id']; ?>" title="Exportar a excel"><i class="fa fa-file-excel-o"></i> Exportar a EXCEL</a></li>
							</ul>
						</div>
