...
$resul =  mysql_query("SELECT * FROM admin_crm.asing_fichas_exclusivas a, form_fichas_opciones_franquicias f where a.id_opcion = f.ref and f.anulado <> 1 and a.id_cliente ='$id_cliente ' and f.nombre_opcion like '%".$texto."%'   "); 


} else {
$resul =  mysql_query("SELECT * FROM admin_crm.asing_fichas_exclusivas a, form_fichas_opciones_franquicias f where a.id_opcion = f.ref and f.anulado <> 1 and a.id_cliente ='$id_cliente ' order by f.ref desc limit 6;");
}
