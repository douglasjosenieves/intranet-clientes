...
<body>
	...
	<div class="pageWrap">
		...
		<div class="pageContent extended">
			<div class="container">
				<h1 class="pageTitle">
					<a href="#" title="#">Cambio de clave</a>
				</h1>
				<ol class="breadcrumb">
				...
				<div class="box rte">
					<h2 class="boxHeadline">Cambie su clave</h2>
...
swal({ 
  title: "Enviado!",
   text: "Su clave ha sido actualizada con exito!",
    type: "success" 
  },
  function(){
 //$('#formulario')[0].reset();
...
sweetAlert("Oops...", "Las contraseñas no coinciden. Intente de nuevo!", "error");
