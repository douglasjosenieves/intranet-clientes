...
$.ajax({
	url: 'async/contactos_nuevos.php',
	type: 'POST',
	dataType: 'html',
...
.done(function(data) {
	...
	var number = data.split('<li>');
	numberfin = number.length -2;
	console.log('Contactos nuevos:'+numberfin);
	$('#contactos_nuevos').html(data) ;

	if (numberfin!=0) {
	$('#contactos_nuevos_total').html(numberfin) ;
	$('#contactos_nuevos_total1').html(numberfin) ;
}
...
console.log('listo ready');
   //verificaChat() ;
   //setInterval(function(){verificaChat();},20000);
...
function verificaChat() {
	...
	.done(function(data) {
		console.log("success chatCabecera comprobado ");
		//console.log(data);
