								...
								<div class="form-group">
								 ...
								 <div class="col-xs-12 col-sm-4">
														<div class="form-group">
													     ...
													     <div class="col-xs-12 col-sm-4">
														<div class="form-group">
															<label for="buscar_cliente">Buscar: <i class="fa fa-arrow-down"></i></label>
															<div class="input-group">
															<input    type="text"   class="form-control" value="" name="buscar_cliente" id="buscar_cliente" placeholder="Buscar clientes:">

															<span id="btn_buscar" class="input-group-addon" style="cursor:pointer; cursor: hand;"><i class="glyphicon glyphicon-search"></i></span>
															</div>
														</div>
	...
	<div class="row">
						 ...
						 <div class="col-xs-12 col-sm-4">
														<div class="form-group">
															...
															<input type="text" required readonly class="form-control" name="nombres" id="nombres" placeholder="Nombres:" value="<?php echo $cliente['cliente'][0]['nombres'] ?>">
														</div>
													</div>
												 ...
												 <div class="col-xs-12 col-sm-4">
														<div class="form-group">
															...
															<input type="text" required readonly class="form-control" value="<?php echo $cliente['cliente'][0]['apellidos'] ?>" name="apellidos" id="apellidos" placeholder="Apellidos:">
														</div>
													</div>
...
function buscarCliente() {
		//alert('buscando');
 		...
 		//alert (cliente);
 		$.ajax({
 			url: 'async/contactos_buscar.php',
 			type: 'POST',
...
$.ajax({
	url: 'envios/seguimiento-insert.php',
	type: 'POST',
	//dataType: 'json',
...
$.ajax({
	url: 'envios/seguimiento-editar.php',
	type: 'POST',
	//dataType: 'json',
