		...
		<div class="pageContent extended">
			<div class="container">
				...
				<div class="box box-without-bottom-padding">
	                ...
	                <?php 
					$i=0;
					$resul =  mysql_query("SELECT * FROM `form_fichas_opciones` where anulado <> 1");
					 ...
					 <!-- Button Extra small -->
						<div class="btn-group">
							...
							<ul class="dropdown-menu">
								<li><a href="forms-fichas-opciones-ver.php?id=<?php echo $opciones['opciones'][$i]['ref']; ?>" title="#"><i class="fa fa-eye"></i> Ver</a></li>
								<li><a href="wn-menu">
								<li><a href="forms-fichas-opciones-ver.php?id=<?php echo $opciones['opciones'][$i]['ref']; ?>&editar=true" title="#"><i class="zmdi zmdi-chart zmdi-edit"></i> Editar</a></li>
								<li><a href="reporte-fichas-opciones-pdf.php?id=<?php echo $opciones['opciones'][$i]['ref']; ?>" title="#"><i class="fa fa-file-pdf-o"></i> Exportar a PDF</a></li>
								<li><a href="reporte-ficha-opciones-excel.php?id=<?php echo $opciones['opciones'][$i]['ref']; ?>" title="Exportar a excel"><i class="fa fa-file-excel-o"></i> Exportar a EXCEL</a></li>
							</ul>
						</div>
